    ...
    <table>
        ...
        @forelse ($categorias as $categoria)
            <tr>
                ...
                <td>3</td>
                <td>
                    <button id="edit"><a href="/categoria/edit/{{ $categoria->id }}">Editar categoría</a></button>
                    <button id="show"><a href="/categoria/show/{{ $categoria->id }}">Mostrar categoría</a></button>
